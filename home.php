<?php
// Optional session handling - sessions not required
...
$isLoggedIn = isset($_SESSION['admin_logged_in']) || isset($_SESSION['user_logged_in']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="header-content">
                ...
                <nav>
                    <ul>
                        ...
                        <?php if ($isLoggedIn): ?>
                            <?php if ($isAdmin): ?>
                                <li><a href="admin_panel.php" class="login-btn">🛡️ Admin Panel</a></li>
                            <?php else: ?>
                                <li><a href="user_dashboard.php" class="login-btn">🎯 Dashboard</a></li>
                            <?php endif; ?>
                            <li><a href="password.php?logout=1" style="background: linear-gradient(135deg, #95a5a6, #7f8c8d); color: white; padding: 0.7rem 1.2rem; border-radius: 8px; font-weight: bold;">🔓 Logout</a></li>
                        <?php else: ?>
